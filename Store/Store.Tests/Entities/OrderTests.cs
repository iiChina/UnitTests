...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Leonardo Chinarelo", "leonardo.chinarelo1@gmail.com");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dados_um_pagamento_do_pedido_seu_status_deve_ser_aguardando_entrega()
        {
            var order = new Order(_customer, 0, null);
        ...
        {
            Discount invalidDiscount = null;
            var order = new Order(_customer, 30, invalidDiscount);
